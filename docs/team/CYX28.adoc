...
*** Wrote relevant sections of Testing Manual, User Guide and Developer Guide
...
include::../UserGuide.adoc[tag=autoremovecompletedTasks]
...
include::../DeveloperGuide.adoc[tag=autoremovecompletedtasks]
