...
* **Alternative 1 (current choice):** Sort tasks by status > due date > priority
** Pros: Incomplete tasks are displayed at the top followed by tasks that are due first and those with higher priority
** Cons: Lack flexibility in sorting by other fields
