...
|`* * *` |business with constantly changing networks |delete a person |remove entries that I no longer need

|`* * *` |business with many contacts |sort persons by name |easily view the details

|`* * *` |business with many contacts |sort persons by tag |easily view the details
...
|`* * *` |traveler and businessman |add new item into the to-do list |to keep track what I need to do

|`* * *` |traveler and businessman |list of items in to-do list | to keep track what I need to do

|`* * *` |traveler and businessman |remove item from to-do list |
...
|`* *` |traveler and businessman |subscribe to mailing list |
