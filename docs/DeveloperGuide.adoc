...
|`* * *` |traveler |delete a person |remove entries that I no longer need

|`* * *` |traveler |sort persons by name |easily view the details

|`* * *` |traveler |sort persons by tag |easily view the details
...
|`* * *` |traveler and businessman |add new information to my user profile |

|`* * *` |traveler and businessman |edit my user profile |it is up-to-date
...
|`* *` |careful businessman|export data |to keep an emergency backup
