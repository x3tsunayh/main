...
The internal details of the sort mechanism is handled by the `sort` method in `UniquePersonList` class. The sort mechanism is implemented using a custom comparator in JavaFX ObservableList `sort` method.
