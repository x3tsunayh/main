...
image::SortingSequenceDiagram.png[width="600"]
...
image::TaskAddSequenceDiagram.png[width="600"]
...
image::TaskDeleteSequenceDiagram.png[width="600"]
...
image::TaskEditSequenceDiagram.png[width="600"]
...
image::TaskEditActivityDiagram.png[width="400"]
// end::task-edit[]
...
image::TaskFindSequenceDiagram.png[width="600"]
...
image::TaskListSequenceDiagram.png[width="600"]
...
image::TaskClearSequenceDiagram.png[width="600"]
