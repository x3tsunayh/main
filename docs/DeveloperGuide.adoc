...
|`* * *` |traveler and businessman |add new item into the to-do list | keep track what I need to do

|`* * *` |traveler and businessman |list of items in to-do list | keep track what I need to do

|`* * *` |traveler and businessman |remove item from to-do list | remove completed tasks
