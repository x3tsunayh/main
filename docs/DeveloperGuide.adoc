...
. The user executes the `task-add` command.
. The `AddressBookParser` class creates a new `TaskAddCommandParser` class to parse the command.
. The `TaskAddCommandParser` class parses the command and create a new `TaskAddCommand` class.
...
. The user executes the `task-delete` command.
. The `AddressBookParser` class creates a new `TaskDeleteCommandParser` class to parse the command.
. The `TaskDeleteCommandParser` class parses the command and create a new `TaskDeleteCommand` class.
...
. The user executes the `task-edit` command.
. The `AddressBookParser` class creates a new `TaskEditCommandParser` class to parse the command.
. The `TaskEditCommandParser` class parses the command and create a new `TaskEditCommand` class.
...
. The user executes the `task-find` command.
. The `AddressBookParser` class creates a new `TaskFindCommandParser` class to parse the command.
. The `TaskFindCommandParser` class parses the command and create a new `TaskFindCommand` class.
