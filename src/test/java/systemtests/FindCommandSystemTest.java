...
public class FindCommandSystemTest extends AddressBookSystemTest {
    ...
    public void find() {
        ...
        /* Case: find phone number of person in address book -> invalid command*/
        command = FindCommand.COMMAND_WORD + " " + DANIEL.getPhone().value;
        assertCommandFailure(command, String.format(MESSAGE_INVALID_COMMAND_FORMAT, FindCommand.MESSAGE_USAGE));
        assertSelectedCardUnchanged();

        /* Case: find address of person in address book -> invalid command */
        command = FindCommand.COMMAND_WORD + " " + DANIEL.getAddress().value;
        assertCommandFailure(command, String.format(MESSAGE_INVALID_COMMAND_FORMAT, FindCommand.MESSAGE_USAGE));
        assertSelectedCardUnchanged();

        /* Case: find email of person in address book -> invalid command */
        ...
        //showAllPersons();
        ModelHelper.setFilteredList(expectedModel, IAN);
        // it only listed 1, which is Ian, why not Benson too
        assertCommandSuccess(command, expectedModel);
        assertSelectedCardUnchanged();
